...
// Inline heroicons-style icons (24x24, currentColor) — same convention as
// the existing settings icon below, so all five tabs render consistently
// without needing separate .svg imports or build-tool config.
const NavIcons = {
  dashboard: (
  ...
  money: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18" height="18" aria-hidden="true">
      ...
      <path fillRule="evenodd" d="M1.5 4.875C1.5 3.839 2.34 3 3.375 3h17.25c1.035 0 1.875.84 1.875 1.875v14.25c0 1.036-.84 1.875-1.875 1.875H3.375A1.875 1.875 0 0 1 1.5 19.125V4.875ZM3 6a1.5 1.5 0 0 0 1.5 1.5A1.5 1.5 0 0 0 6 6a1.5 1.5 0 0 0-1.5-1.5A1.5 1.5 0 0 0 3 6Zm12 0a1.5 1.5 0 0 0 1.5 1.5A1.5 1.5 0 0 0 18 6a1.5 1.5 0 0 0-1.5-1.5A1.5 1.5 0 0 0 15 6ZM4.5 18a1.5 1.5 0 0 1 1.5-1.5 1.5 1.5 0 0 1 1.5 1.5 1.5 1.5 0 0 1-1.5 1.5A1.5 1.5 0 0 1 4.5 18Zm12 0a1.5 1.5 0 0 1 1.5-1.5 1.5 1.5 0 0 1 1.5 1.5 1.5 1.5 0 0 1-1.5 1.5 1.5 1.5 0 0 1-1.5-1.5Z" clipRule="evenodd" />
    </svg>
  ),
  budget: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18" height="18" aria-hidden="true">
